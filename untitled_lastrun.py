...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Semester_7\\Thesis\\self_other_shapelabel-main\\bhaktiexperiment\\untitled_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_3 = visual.TextStim(win=win, name='text_3',
        text='Your task is to judge whether the presented shape-label paring is match or non-match.\n\n- If the shape-label paring was a match, press “M”\n- If the shape-label pairing was a non-match, press “N”\n\nRepond as quickly as possible. \n\nPress space to continue ',
        font='Arial',
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        text='The square is self \nThe triangle is other \n\nPress spacebar to continue',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    image = visual.ImageStim(
        ...
        ori=0.0, pos=(0, 0.2), draggable=False, size=(0.1, 0.1),
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[polygon, text, key_resp, image, polygon_2],
        )
